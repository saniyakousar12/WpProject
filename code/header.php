        ...
        <div class="px-3 py-2 text-bg-dark">
            <div class="container">
                ...
                <ul class="nav nav-pills">
                    <li class="px-5 py-0 nav-item "><a href="#" class="nav-link nav-elem text-light fs-3 text-uppercase fw-light disabled me-5">Style Mansion</a></li>
                    <li class="nav-item "><a href="home.php" class="nav-link nav-elem text-white mt-1 mx-5 fs-5" aria-current="page">Home</a></li>
                    <li class="nav-item  dropdown">
                        <a href="#" class="nav-link nav-elem dropdown-toggle text-white mt-1 mx-3 fs-5" role="button" data-bs-toggle="dropdown" aria-expanded="false">Collection</a>
                    ...
                    <li class="nav-item "><a href="lookbook.php" class="nav-link nav-elem text-white mt-1 mx-3 fs-5">Lookbook</a></li>
                    <li class="nav-item "><a href="customer_care.php" class="nav-link nav-elem text-white mt-1 mx-3 fs-5">Customer Care</a></li>
                </ul>
                </header>
            </div>
        </div>
